...
The following sections explore different model-changing operations one can perform over \ultss, discussing their interpretations as well as technical results. While some examples of ontic changes will be discussed in \Cref{sec:ontic}, the main focus of the article is on epistemic updates (\Cref{sec:epistemic-basic} and \Cref{sec:extension}).
