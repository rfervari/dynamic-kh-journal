...
The following sections explore different model-changing operations one can perform over \ultss, discussing their interpretations as well as some of their technical results. While ontic changes will be discussed to some extent (\Cref{sec:ontic} below), the main focus will be epistemic updates (\Cref{sec:epistemic-basic} and \Cref{sec:extension}), as they describe changes in abilities driven not by changes in the environment, but rather by changes in the agents' epistemic state.
