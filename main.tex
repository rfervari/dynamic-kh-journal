...
\affil[1]{\orgname{Consejo Nacional de Investigaciones Cientificas y Tecnicas ({CONICET})}, \country{Argentina}}
% \orgdiv{Department}, 
...
\raul{I would put the proofs into the text (or part of them), or remove the appendix anyway.}
\appendix
\input{appendix}
\end{document}
