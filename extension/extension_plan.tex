...
The latter, is expressed by the predicate $P(\plan,\srefbox{\plan}\varphi_2)$, defined below. The complete list of reduction axioms for $\PlanReflogic$ are introduced in~\Cref{tab:srefaxiom}.
