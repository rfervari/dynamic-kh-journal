...
\item
$\Unc(k) = \set{\plans_1,\plans_2,\plans_3}$, where  $\plans_1=\set{a_1b_1}$, $\plans_2=\set{a_1}$, $\plans_3= \setof{a_i b_i}{i \in \natnum \setminus \set{1}}$, and
...
\carlos{cuan grande es el modelo filtrado?  Tiene sentido incluir an upper bound for complexity?s}
