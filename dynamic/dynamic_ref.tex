As it has been discussed, \ults{s} allow a natural representation of the actions that affect both the abilities of an agent and her epistemic state. In an \ults, the crucial epistemic components are the sets $\Unc(i)$, defining the plans agent $i$ is aware of, and the degree at which she can discern among them. Thus, we can represent changes in the epistemic state of
