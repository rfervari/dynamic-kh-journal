...
The resulting modality is normal and serial, satisfies natural properties 
of Monotonicity and Weakening, but fails for dynamic versions of axioms 4 and  (usually known as \emph{positive} and \emph{negative introspection}). 
...
Again, we conclude by establishing that uniform substitution fails in this logic.
