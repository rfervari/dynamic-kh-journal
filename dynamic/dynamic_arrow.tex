...
\begin{proof} The proof proceeds by cases, and again we focus only in $\axm{RKh}$.
	\begin{itemize}
	...
	\item For \axm{RKh}, let $U = (\theta,\theta')$, by the definition of $\arrowbox{U}$, $\modults,w \models \arrowbox{U}\khi(\varphi,\psi)$ iff $\arrowmodelU,w \models \khi(\varphi,\psi)$.
