...
Public Announcement Logic (\PAL) extends the basic modal logic with a dynamic operator $[\chi]$ to represent this kind of updates. Given an $\ults$ $\modults=\tup{\W,\R,\Unc,\V}$, the semantic interpretation of $[\chi]$ is defined as:
\begin{spcenter}
