...
\begin{mrevised}
A couple of remarks might be useful here. In the original knowing how setting with semantics defined in terms of \lts{s}, edges can be taken to encode the agen's' \emph{epistemic take on her abilities}~\cite{Wang2016}. I.e., the actions she consider possible, the preconditions required of a given situation for their execution, and the effects they have (how a situation is changed under the execution of a given action).
