...
In order to understand the expressive power of a formal language, \emph{bisimulation} is a crucial tool. Here we review the notion of bisimulation for $\KHilogic$ over \ultss, first introduced in~\cite{AFSVQ23report}. We start by providing some useful abbreviations.
...
Strong completeness of the axiomatization above is established in~\cite{AFSVQ21,AFSVQ23report} via a canonical model construction. By taking such a model, and selecting relevant pieces of it, we can prove a small (polynomial) model property. This property is important in establishing complexity results.
