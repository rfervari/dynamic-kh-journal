...
Strong completeness of the axiomatization above is established in~\cite{AFSVQ21,AFSVQ23report} via a canonical model construction (modulo the correction just mentioned). In addition, 
